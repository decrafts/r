...
Помимо рабочих функций в коде остаются закомментированные рудимнты от часов реального времени, 
...
Также отправляются данные [на сайт народного мониторинга](https://narodmon.ru/4231),
